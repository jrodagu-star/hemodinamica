          ...
          <section>
            ...
            <figure className="mt-6 flex flex-col items-center">
              <button
                ...
                className="group flex max-w-full cursor-zoom-in justify-center overflow-hidden rounded-2xl border border-red-100 bg-white p-3 shadow-inner transition hover:ring-2 hover:ring-red-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
              ...
              <figcaption className="mt-2 max-w-xl text-center text-[11px] leading-relaxed text-slate-600">
                Lectura en consola: P<sub>ven</sub>, P<sub>int</sub>, P<sub>Art</sub>, Δp, caudal,
                rpm, T y SvO₂.{' '}
