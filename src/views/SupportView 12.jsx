      ...
      <div className="overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white shadow-sm">
        ...
        <div className="space-y-12 p-8 text-left md:p-10">
          ...
          <section className="rounded-3xl border border-red-100 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 min-[480px]:gap-6 sm:gap-8">
              {ECMO_CONFIGURACIONES_ITEMS.map((item) => (
                <figure key={item.id} className="flex min-w-0 flex-col items-center">
                  <button
                    ...
                    className="group flex w-full max-w-full cursor-zoom-in justify-center overflow-hidden rounded-2xl border border-red-100 bg-red-50/30 p-1.5 shadow-inner transition hover:ring-2 hover:ring-red-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 min-[480px]:p-3"
                    aria-label={`Ampliar: ${item.caption}`}
                  >
                    <img
                      src={item.src}
                      alt=""
                      className="max-h-[120px] w-auto max-w-full object-contain min-[480px]:max-h-[160px] sm:max-h-[180px]"
                      loading="lazy"
                    />
                  </button>
                  <figcaption className="mt-2 w-full min-w-0 max-w-md text-center sm:mt-3">
                    <p className="text-[9px] font-black uppercase leading-tight tracking-wide text-red-900 min-[480px]:text-[11px]">
                      {item.caption}
                    </p>
                    <p className="mt-1.5 text-left text-[10px] leading-snug text-slate-700 min-[480px]:mt-2 min-[480px]:text-[12px] min-[480px]:leading-relaxed sm:text-[13px]">
                      {item.description}
                    </p>
